package demo.spring.boot.docker.config;
...
public class Swagger2Configuration {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)//Docket, Springfox’s, primary api configuration mechanism is initialized for swagger specification 2.0
                ...
                .apis(RequestHandlerSelectors.basePackage("demo.spring.boot.docker.controller.pub"))
    ...
    public Docket privateApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("demo.spring.boot.docker.controller.pvt"))
    ...
    public Docket aspectApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("demo.spring.boot.docker.controller.aspect"))
                .paths(PathSelectors.any())
                .build()
                .forCodeGeneration(true)
                .pathMapping("/")
    ...
    public Docket authApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("auth-api")
                .select()
                .apis(RequestHandlerSelectors.basePackage("demo.spring.boot.docker.controller.auth"))
                .paths(PathSelectors.any())
                .build()
                .forCodeGeneration(true)
                .pathMapping("/")
